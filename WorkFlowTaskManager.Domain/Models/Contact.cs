...
namespace WorkFlowTaskManager.Domain.Models
{
    public class Contact : BaseEntity, ISoftDeletableEntity
    {
        ...
        //FK reference for Campaign Assigned Contact
        public ICollection<ContactAssignedAudience> CampaignAssignedContacts { get; set; }

        //FK reference for Intenral Company Assigned Contact
